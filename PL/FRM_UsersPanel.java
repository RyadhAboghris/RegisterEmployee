 ...
 * @author ryadh
 */
public class FRM_UsersPanel extends javax.swing.JPanel {
    ...
    public FRM_UsersPanel() {
        ...
        table.setModel(new DefaultTableModel(new Object[][]{}, new String[]{"اسم المستخدم", "الاسم", "الرقم السري", "العمليات", "الصورة"}) {
...
//table.getColumnModel().getColumn(4).
    ...
    void initAddOrEditOrDetailsUser(FRM_AddOrEditOrDetailsUser faedu) {
...
//        }
        ...
        ArrayList<User> users = cls.search(txt_search.getText().trim(), selectedNum * 20);
        ...
        for (User user : users) {
            ...
            if (user.getImage() != null) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon(user.getImage()).getImage()
