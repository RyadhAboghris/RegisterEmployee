 ...
 * @author ryadh
 */
public class FRM_SectionsPanel extends javax.swing.JPanel {

    /**
     * Creates new form MainPanel
     */
    CLS_Section cls = new CLS_Section();
    DefaultTableModel model;
    int selectedNum = 0;
    FRM_EmployeePanel ep;

    public FRM_SectionsPanel() {
        initComponents();
        ...
        TableActionEvent event = new TableActionEvent() {
            ...
            public void onEdit(int row) {
                ...
                FRM_AddOrEditOrDetailsSection faedu = new FRM_AddOrEditOrDetailsSection();
        ...
        table.setModel(new DefaultTableModel(new Object[][]{}, new String[]{"الاسم", "العمليات", "الصورة"}) {
...
//table.getColumnModel().getColumn(4).
    ...
    void initAddOrEditOrDetailsSection(FRM_AddOrEditOrDetailsSection faedu) {
        faedu.initJPanel(this,ep);
    ...
    public void setValues(FRM_EmployeePanel employeePanel){
    ep=employeePanel;
    }
...
//        }
        ...
        ArrayList<Section> sections = cls.search(txt_search.getText().trim(), selectedNum * 20);
        Object[] row = new Object[3];
        for (Section section : sections) {
            row[0] = section.getName();
            if (section.getImage() != null) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon(section.getImage()).getImage()
